...
export const bannerData = [
    {
        image: "https://res.cloudinary.com/dkg6jv4l0/image/upload/v1731710065/Let_s-build-a-production-ready-LMS-Mobile-App-with-Expo-React-Native_ahqpvx.png",
        url: "https://youtu.be/0sfVmH5_nj4",
    },
    {
        image: "https://res.cloudinary.com/dwp4syk3r/image/upload/v1713574008/WhatsApp_Image_2024-02-29_at_2.00.10_AM_zpk4qe.jpg",
        url: "https://youtu.be/BrrwtCt7d-Y",
    },
    {
        image: "https://res.cloudinary.com/dkg6jv4l0/image/upload/v1723424082/WhatsApp_Image_2024-08-09_at_5.00.52_AM_wzokd1.jpg",
...
export const videoLessonsData = [
    {
        ...
        title: "All Functional LMS mobile App with React Native,Expo,Typescript,Express js",
    },
    {
        url: "https://youtu.be/BrrwtCt7d-Y",
        thumbnail:
        ...
        title: "SaaS Email Newsletter platform by using next14, typescript, AWS SES, AstraDb, Stripe",
    },
    {
    ...
    },
    {
        ...
        title: "Food Delivery Web Application using Microservice Architecture with Nest.js,GraphQL,Next.js",
    },
    {
        ...
        title: "Let's Make a Full-stack Website Without a Backend Next 14 | OneEntry CMS | Tailwind css | Typescript",
    },
    {
        url: "https://youtu.be/4aS7g8OYHbg",
        thumbnail:
            "https://res.cloudinary.com/dkg6jv4l0/image/upload/v1723424082/WhatsApp_Image_2024-08-09_at_5.00.52_AM_wzokd1.jpg",
        title: "Let's build one real-time car booking full-stack mobile app by using Expo React Native",
    },
];
...
export const FAQData = [
    {
        ...
        answer: "Yes — each student who completes any course will receive a certificate of completion to acknowledge their proficiency. We encourage students to include these on their LinkedIn profiles and in their job applications!",
    },
    {
        id: 2,
